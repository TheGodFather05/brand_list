...
class BrandSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Brand::factory()->create(["brand_country" => "BE", "brand_name" => "Legend Play", "brand_image" => "https://www.casinoonlinefrancais.info/cdn-cgi/image/format=auto,width=75,height=75,quality=80/img/logo300/LegendPlay-Casino.png", "rating" => 3]);
        Brand::factory()->create(["brand_country" => "BE", "brand_name" => "Slot Paradise", "brand_image" => "https://www.casinoonlinefrancais.info/cdn-cgi/image/format=auto,width=75,height=75,quality=80/img/logo300/slotparadise-casino.png", "rating" => 3]);
